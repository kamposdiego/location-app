...
class CountryRestController {
    ...
    public ResponseEntity<EntityModel<Country>> getCountryById(@Parameter(name = "country-id", description = "Country identifier.", required = true, in = ParameterIn.PATH) @PathVariable("country-id") Long id) {
        ...
        Country country = countryGetLocation.getCountry(GetCountryUseCase.GetCountryCommand
                        .builder()
    ...
    public ResponseEntity<EntityModel<Country>> saveCountry(@Parameter(name = "x-idempotency-key", description = "Idempotency key generated by client.", required = true, in = ParameterIn.HEADER) @RequestHeader(value = "x-idempotency-key", required = true) UUID idempotencyKey, @Valid @RequestBody(required = true) Country countryLocationEvent) {
        Country country = countrySaveLocation.saveCountry(SaveCountryUseCase.SaveCountryCommand
                .builder()
    ...
    public ResponseEntity<EntityModel<Country>> updateCountry(@RequestBody Country countryLocationEvent) {
        ...
        Country country = updateCountryUseCase.updateCountry(UpdateCountryUseCase.UpdateCountryCommand
                .builder()
                .country(Country.builder()
    ...
    public ResponseEntity<Void> deleteCountry(@Parameter(name = "country-id", description = "Country identifier.", required = true, in = ParameterIn.PATH) @PathVariable("country-id") Long id) {
        ...
        deleteCountryUseCase.deleteCountry(DeleteCountryUseCase.DeleteCountryCommand
                .builder()
                .country(Country.builder()
                        .id(id)
                        .build())
